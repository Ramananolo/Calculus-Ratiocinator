...
public class ConjoctionEt extends Affirmation {
    private final Affirmation affirmation1;
    private final Affirmation affirmation2;

    public ConjoctionEt(String texte,Affirmation affirmation1, Affirmation affirmation2) {
        super(texte);
    ...
    public boolean verité() {
        ...
        return affirmation1.verité() && affirmation1.verité();
    }
}
